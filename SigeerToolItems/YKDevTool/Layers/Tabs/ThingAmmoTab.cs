...
public class ThingAmmoTab : YKLayout<Thing> {
    public override void OnLayout() {
        var thing = Layer.Data.ammoData;
        var headerWidth = 120;
        Header(Layer.Data.GetName(NameStyle.Full));
        if (thing == null) {
            Text("矢弾が装填されていません"._("No ammo loaded")).WithWidth(300);
            return;
        }
